function CategoryFilter({ selectedCategory, onCategoryChange }) {
  const categories = [
    ...
    { value: 'Medical Equipment', label: 'Alat Medis', icon: '🩺', color: 'purple' }
  ];
  
  return (
    <div className="mb-8">
      <h2 className="text-sm font-semibold text-gray-700 mb-3">Kategori Produk</h2>
        ...
        {categories.map(cat => {
          ...
          return (
            <button
              ...
              `}
              style={{
                backgroundColor: isSelected ? getCategoryColor(cat.color) : undefined
              }}
            >
